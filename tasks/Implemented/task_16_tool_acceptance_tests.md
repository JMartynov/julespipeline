# Task 16: Tool acceptance tests

**Phase:** Phase 5 - Acceptance Tests

## Description
Create `tests/acceptance/` tests using real PDF files for each tool independently.

**Best Practices:**
- Use real-world, obfuscated PDFs (e.g., sample bank statements, public research papers) to catch edge cases that synthetic unit tests miss.
- Define strict acceptance criteria (e.g., "Must extract 5 tables from `financial_report.pdf`").
